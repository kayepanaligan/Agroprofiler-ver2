...
const Heatmap: React.FC<HeatmapProps> = ({
    ...
    const onEachFeature = (feature: any, layer: any) => {
        ...
        `;
            ...
            tooltipContent += `${barangayName} received ${allocationPercentage}% of the allocation type ${subtype}.`;
        } else if (
            view === "commodities" &&
            category !== "All" &&
            subtype !== "All"
            ...
            tooltipContent += `${category} ${subtype}: ${commodityCount} commodities`;
        }
                ...
                {geoData && (
                    <GeoJSON
                        ...
                        onEachFeature={(feature: any, layer: any) => {
                            ...
                            // Get the value based on selected distribution
                            let value = "No Data";
                            if (
                                view === "commodities" &&
                                category !== "All" &&
                                ...
                                value =
                                    data?.commodities?.[category]?.[subtype] ||
                                    "No Data";
                            } else if (
                                view === "allocations" &&
                                subtype !== "All"
                                ...
                                value =
                                    data?.allocations?.[subtype] || "No Data";
                            } else if (view === "farmers") {
                                value = data?.farmers?.[subtype] || "No Data";
                            }
