            ...
            <div className="">
                ...
                <div className="flex gap-2 justify-center content-center">
                    <Link href={route("logout")} method="post" as="button">
                        <span className="inline-flex mt-3 gap-1 text-[10px] font-semibold dark:hover:bg-red-700 text-red-600 border p-2 rounded-lg shadow-lg  hover:bg-red-200 hover:text-red-400">
                            <Power size={15} />
                            Log Out
                        </span>
                    </Link>
