...
const Heatmap: React.FC<HeatmapProps> = ({
    ...
    const getColor = (barangayName: string) => {
        ...
        if (view === "allocations" && subtype !== "All") {
            ...
            const totalAllocationAmount = allocationTypeData
                ? parseFloat(allocationType.amount)
                : 0;

            percentage = (allocationAmount / totalAllocationAmount) * 100;
    ...
    const onEachFeature = (feature: any, layer: any) => {
        ...
        ${barangayName} received ${allocationPercentage}% ${allocationAmount} of ${subtype} (${totalAllocationAmount})
    `;
        } else if (
            view === "commodities" &&
            category !== "All" &&
