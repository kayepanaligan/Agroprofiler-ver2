            ...
            <div className="">
                <span className="inline-flex">
                    <Link
                        ...
                        className="inline-flex dark:border-green-600 border-[2px] items-center py-4 px-2 text-sm  leading-4 font-medium rounded-[1rem] text-gray-500 bg-transparent hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                    >
                        <img
                        ...
                        <div className="text-left mx-2">
                            <div className="flex ">
                                <span className="capitalize dark:text-black text-[12px] text-black dark:text-green-600">
                                    {user.firstname}
                                </span>
                            ...
                            <div>
                                <span className="capitalize dark:text-slate-900 text-[11px]">
                                    ({user.role})
                                </span>
                            </div>
                        </div>
