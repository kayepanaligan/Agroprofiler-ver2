...
const Heatmap: React.FC<HeatmapProps> = ({ distributionData }) => {
    ...
    return (
        <div className="heatmap-container">
            <div className="select-container mb-10 grid lg:grid-flow-row lggrid-rows-1 md:grid-flow-col md:grid-cols-2 gap-4">
                <select
                    value={view}
                ...
                <select
                    ...
                    value={subtype}
                    className="rounded-[12px] border-slate-500  cursor-pointer focus:border-green-500"
                >
