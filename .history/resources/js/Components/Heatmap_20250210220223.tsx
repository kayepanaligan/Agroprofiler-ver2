        ...
        <div className="heatmap-container">
            <div className="select-container mb-10 grid lg:grid-flow-row lg:grid-rows-1 md:grid-flow-col md:grid-cols-2 gap-4">
                <select
                    ...
                    className="border-slate-400 rounded-xl cursor-pointer focus:border-green-500 md:text-[14px]"
                >
                ...
                <select
                    ...
                    value={subtype}
                    className="rounded-[12px] border-slate-500  cursor-pointer focus:border-green-500 md:text-[14px]"
                >
