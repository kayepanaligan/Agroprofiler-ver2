    ...
    const datas = [
        {
            ...
            demographic: "Cash Assistance",
            value: 20000,
        },
        {
            allocationType: "Department of Agriculture",
            demographic: "Machinery",
            value: 200,
        },
        { allocationType: "LGU", demographic: "4Ps", value: 300 },
    ];

    const allocationTypess = ["Department of Agriculture", "LGU"];
    const demographicss = ["Cash Assistance", "Machinery"];
