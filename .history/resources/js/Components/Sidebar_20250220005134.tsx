...
export default function Sidebar({ user }: Props) {
    ...
    return (
        <div
            className={`fixed index-20 p-5 overflow-x-auto bg-white dark:bg-[#0D1A25] rounded-[1rem] ml-3 shadow {expanded ? "w-[200px]" : "w-[200px]}`}
        >
            ...
            {expanded ? (
                ...
                <button
                    onClick={toggleTheme}
                    className="p-2 rounded-full mb-4 dark:bg-yellow-400 transition"
                >
                    {theme === "dark" ? (
