...
export default function Sidebar({ user }: Props) {
    ...
    return (
        <div
            className={`fixed index-20 w-[15%] mt-5 p-5 overflow-hidden bg-white rounded-[1rem] ml-3 shadow  {expanded ? "w-[10rem]" : "w-[20rem]}`}
        >
            <div className="w-full h-auto p-4 flex justify-center content-center">
                <button
                    onClick={() => setExpanded((curr) => !curr)}
                    className="transition-all font-semibold text-green-700 text-[18px]"
                >
                    Agroprofiler
                </button>
            </div>
            ...
            <div className="border-t">
                <span className="inline-flex rounded-md">
                    <Link className="inline-flex items-center py-4 px-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                        <img
            ...
            <div className="hidden sm:flex sm:items-center sm:ms-6 border-t">
                <div className="ms-6 relative p-4 w-full h-[400px]">
                    <Dropdown>
                        <Dropdown.Trigger>
                            <span className="inline-flex rounded-md">
                                <button
