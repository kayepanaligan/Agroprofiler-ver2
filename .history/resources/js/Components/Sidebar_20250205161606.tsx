...
export default function Sidebar({ user }: Props) {
    ...
    return (
        <div
            className={`fixed index-20 w-[16%] mt-5 p-5 overflow-x-auto bg-white rounded-[1rem] ml-3 shadow  {expanded ? "w-[10rem]" : "w-[20rem]}`}
        >
            <div className="w-full h-auto p-4 flex justify-center content-center border-b mb-2">
                <button
