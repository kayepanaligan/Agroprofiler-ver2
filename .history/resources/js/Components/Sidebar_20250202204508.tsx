...
export default function Sidebar({ user }: Props) {
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-flow-row grid-rows-3 border-t p-4">
                <div className="inline-flex grid grid-flow-row grid-rows-2">
                    <img
                    ...
                    <div className="grid grid-flow-row grid-rows-2">
                        <span className="capitalize font-semibold flex justify-center content-center p-4 text-sm">
