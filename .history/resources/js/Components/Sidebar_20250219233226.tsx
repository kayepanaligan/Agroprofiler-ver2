    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-center p-4">
                {expanded ? (
                    <div
                        className={`relative w-[100px] h-15 flex items-center rounded-full p-1 cursor-pointer transition ${
                            theme === "dark" ? "bg-yellow-400" : "bg-gray-300"
                        }`}
                        onClick={toggleTheme}
                    >
                        <div
                            className={`w-12 h-12 bg-white rounded-full shadow-md transform transition ${
                                theme === "dark"
                                    ? "translate-x-12"
                                    : "translate-x-0"
                            }`}
                        />
                        <span className="absolute flex justify-center items-center left-6 text-xs text-black dark:text-white">
                            <Sun className="w-7 h-7 text-yellow-500" />
                        </span>
                        <span className="absolute right-2 text-xs text-black dark:text-white">
                            <Moon className="w-6 h-6 text-blue-950" />
                        </span>
                    </div>
                ) : (
                    <button
