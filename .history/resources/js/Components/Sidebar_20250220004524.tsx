            ...
            <div className=" w-[230px] text-ellipsis">
                {expanded ? (
                    ...
                    <span>
                        <Link
                            href={route("profile.edit")}
                            className="inline-flex dark:border-green-600 border-[2px] items-center py-2 px-2 text-sm leading-4 font-medium rounded-[1rem] text-gray-500 bg-transparent hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                        >
                            <User2 size={20} />
                        </Link>
                    </span>
