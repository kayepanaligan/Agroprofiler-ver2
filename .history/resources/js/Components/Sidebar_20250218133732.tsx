                ...
                <span className="inline-flex">
                    ...
                    >
                        ...
                        <div className="text-left mx-2">
                            <div className="flex ">
                                <span className="capitalize text-[12px] text-black dark:text-green-600">
                                    {user.firstname}
                                </span>

                                <span className="capitalize dark:text-green-600 text-[12px] text-black">
                                    {user.lastname}
                                </span>
                            </div>
                            <div>
                                <span className="capitalize dark:text-white font-thin text-[11px]">
                                    ({user.role})
                                </span>
                            </div>
                        </div>
