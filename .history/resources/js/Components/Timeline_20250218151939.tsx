    ...
    return (
        <div className="flex items-start gap-4">
            <div className="flex flex-col items-center">
                ...
                {hasNext && (
                    <div
                        className="w-[2px] bg-slate-200 dark:bg-green-900"
                        style={{ height: "220px" }}
                    ></div>
                )}
            </div>
            <div className="mb-6 bg-white dark:bg-transparent dark:border-green-600 p-4 w-[800px] rounded-md border-[2px] flex gap-4">
                ...
                <div className="flex-1">
                    {Object.keys(fields).map((key) =>
                        ...
                        !fields[key].match(/\.(jpeg|jpg|gif|png)$/) ? (
                            <p
                                key={key}
                                className="text-[14px] text-gray-600 text-ellipsis"
                            >
        ...
        <div className="timeline-container">
            <div className="mb-4 ml-12">
                <TextInput
                    ...
                    className="w-[430px] px-4 py-2 border border-gray-300 dark:border-green-400 rounded-md shadow-sm"
                />
            </div>
            <div className="timeline mt-4 text-white overflow-auto w-full p-4 h-[350px]">
