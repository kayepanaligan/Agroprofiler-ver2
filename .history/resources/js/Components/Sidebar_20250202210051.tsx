...
export default function Sidebar({ user }: Props) {
    ...
    return (
        <div
            className={`fixed index-20 w-[15%] mt-20 p-5 overflow-hidden bg-white rounded-[1rem] ml-3 shadow  {expanded ? "w-[10rem]" : "w-[20rem]}`}
        >
            ...
            <div className="border-t">
                <span className="inline-flex rounded-md">
                    <button
                        type="button"
                        role="link"
                        className="inline-flex items-center py-4 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                    >
                        <img
