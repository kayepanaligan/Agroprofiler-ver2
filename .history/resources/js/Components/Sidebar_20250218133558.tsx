            ...
            <div className="">
                <span className="inline-flex">
                    <Link
                        ...
                        className="inline-flex dark:border-green-600 border-[1px] items-center py-4 px-2 text-sm leading-4 font-medium rounded-[1rem] text-gray-500 bg-transparent hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                    >
                        <img
