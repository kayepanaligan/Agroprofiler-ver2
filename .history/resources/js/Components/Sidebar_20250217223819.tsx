...
export default function Sidebar({ user }: Props) {
    ...
    return (
        <div
            className={`fixed index-20 w-[17%] mt-5 p-5 overflow-x-auto bg-white dark:bg-[#0D1A25] rounded-[1rem] ml-3 shadow {expanded ? "w-[10rem]" : "w-[20rem]}`}
        >
            ...
            <div className="overflow-auto h-[420px] ">
                <ul>
                    ...
                    <li className="text-m mb-5 ">
                        ...
                        >
                            <div className="flex gap-2 dark:text-white hover:text-green-500">
            ...
            <div className="">
                <span className="inline-flex rounded-md">
                    <Link
                        ...
                        className="inline-flex dark:bg-green-600 items-center py-4 px-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                    >
                        <img
                        ...
                        <div className="text-xs text-left mx-2">
                            <div className="flex ">
                                <span className="capitalize dark:text-black text-[12px] text-black">
                                    {user.firstname}
                                </span>
                            ...
                            <div>
                                <span className="capitalize dark:text-slate-700 text-[11px]">
                                    ({user.role})
                                </span>
                            </div>
                        </div>
                ...
                <div className="flex gap-2 justify-center content-center">
                    <Link href={route("logout")} method="post" as="button">
                        <span className="inline-flex mt-3 gap-1 text-[10px] font-semibold dark:hover:bg-red-700 dark:hover:text-white text-red-600 border p-2 rounded-lg shadow-lg  hover:bg-red-200 hover:text-red-400">
                            <Power size={15} />
                            Log Out
                        </span>
                    </Link>
