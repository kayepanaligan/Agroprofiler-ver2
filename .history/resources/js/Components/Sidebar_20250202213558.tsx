    ...
    return (
        ...
        >
            ...
            <div className="border-t">
                ...
                <div className="flex gap-2 flex justify-center content-center">
                    <Link href={route("logout")} method="post" as="button">
                        <span className="inline-flex gap-1 text-sm font-semibold text-red-600 border p-2 rounded-full shadow-lg  hover:bg-red-200 hover:text-red-400">
                            <Power size={18} />
                        </span>
                    </Link>
                </div>
