                        ...
                        <>
                            ...
                            <div className="p-4 mb-2">
                                <div className="w-full p-4 border rounded-lg">
                                    ...
                                    <span className="p-4 mt-4 text-justify">
                                        In Barangay {selectedBarangay?.name} a total of 500 allocations were
                                        distributed, with 60% allocated as Cash Assistance, 25% as Pesticides, and 15%
                                        as Seeds. The average allocation per
                                        household was 2,000 pesos, with
                                        allocations primarily benefiting
                                        registered farmers (75%) and 4Ps
                                        beneficiaries (20%). The highest
                                        concentration of allocations was seen in
                                        barangays affected by recent floods,
                                        with a notable 80% increase in Cash
                                        Assistance over the last quarter. These
                                        allocations have significantly improved
                                        farmers' access to resources, though the
                                        distribution remains skewed towards the
                                        most vulnerable communities.
                                    </span>
                                </div>
                            </div>
                            <div className="p-4 grid grid-flow-row grid-rows-4 gap-4">
                                <div>
                                    <DonutChart
                                        data={sampleData}
