                            ...
                            <div className="p-4 mb-2">
                                <div className="w-full p-4 border rounded-lg">
                                    ...
                                    <span className="p-4 mt-4">
                                        In Barangay {selectedBarangay} a total
                                        of 500 allocations were distributed,
                                        with 60% allocated as Cash Assistance,
                                        25% as Pesticides, and 15% as Seeds. The
                                        average allocation per household was
                                        2,000 pesos, with allocations primarily
                                        benefiting registered farmers (75%) and
                                        4Ps beneficiaries (20%). The highest
