    ...
    return (
        ...
        >
            ...
            <div>
                <button
                    onClick={toggleTheme}
                    className="p-2 rounded-full bg-yellow-400 dark:bg-gray-700 transition"
                >
                    {theme === "dark" ? (
            ...
            <div className="overflow-auto h-[420px] ">
                <ul>
                    <span className="ml-2 mb-4 text-sm text-white">Main</span>
                    ...
                    <span className="ml-2 mb-4 text-sm text-white">List</span>
                    ...
                    <br />
                    <span className="ml-2 mb-4 text-sm font-semibold text-white">
                        Reports
                    </span>
                    <li
                        className="text-m "
