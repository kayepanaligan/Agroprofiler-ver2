            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                <div className="relative">
                    <TextInput
                        ...
                        readOnly
                        className="cursor-pointer text-gray-500 text-xs relative pl-20 pr-4 py-2 border border-gray-300 rounded-md bg-white w-50 h-100"
                        style={{
                    ...
                    <input
                        type="file"
                        accept="image/*"
                        className="absolute inset-0 opacity-0 cursor-pointer h-50"
