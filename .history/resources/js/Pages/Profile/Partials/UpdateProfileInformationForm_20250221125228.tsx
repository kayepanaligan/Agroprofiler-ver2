            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                <div className="relative w-[100px] h-[100px]">
                    <TextInput
                        ...
                        readOnly
                        className="cursor-pointer text-gray-500 text-xs border border-gray-300 rounded-md bg-white w-full h-full"
                        style={{
                            ...
                            borderRadius: "8px", // Optional: Adjust for softer edges
                        }}
                    />
                    <input
                        type="file"
