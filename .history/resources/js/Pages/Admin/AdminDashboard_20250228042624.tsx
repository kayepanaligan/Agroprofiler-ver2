...
export default function Dashboard({
    ...
    useEffect(() => {
        axios.get("/admin/api/stacked-data").then((response) => {
    ...
    const sampleData = [
        { name: "Barangay A", "Cash Assistance": 500, Fertilizer: 300 },
        { name: "Barangay B", "Cash Assistance": 700, Fertilizer: 400 },
    ];
    ...
    return (
        ...
        >
            ...
            <div className="flex mb-5 gap-4 w-[100px]">
                <select
                    value={currentYear}
                    onChange={(e) => {
