...
export default function AllocationTypeList({ auth }: PageProps) {
    ...
    const rows: AllocationTypeRow[] = (allocationTypes || []).map(
        (type, index) => ({
            ...
            // ✅ Fix: Ensure these fields remain as arrays of objects, not strings
            allocation_type_commodities: Array.isArray(
                type.allocation_type_commodities
            )
                ? type.allocation_type_commodities.map((c) => ({
            ...
            allocation_type_barangays: Array.isArray(
                ...
                ? type.allocation_type_barangays.map((b) => ({
            ...
            allocation_type_crop_damage_causes: Array.isArray(
                ...
                ? type.allocation_type_crop_damage_causes.map((d) => ({
                      crop_damage_cause_id: d.crop_damage_cause_id,
                      crop_damage_cause_name: d.crop_damage_cause_name,
                  }))
                : [],
            ...
            allocation_type_elligibilities: Array.isArray(
                ...
                ? type.allocation_type_elligibilities.map((e) => ({
                      elligibility_id: e.elligibility_id,
                      elligibility_type: e.elligibility_type,
                  }))
                : [],
        })
    );
