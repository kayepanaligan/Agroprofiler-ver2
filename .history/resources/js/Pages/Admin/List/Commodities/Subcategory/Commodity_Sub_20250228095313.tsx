    ...
    const fetchCategories = async () => {
        try {
            const response = await axios.get(
                "/admin/commodity-categories-show"
            );
        ...
        try {
            ...
            if (isEdit) {
                response = await axios.post(
                    `/admin/commodities/update/${formData.id}`, // Still using POST for update
                    requestData
                );
            } else {
                response = await axios.post(
                    "/admin/commodities/store",
                    formData
                );
            }
        ...
        >
            ...
            <div>
                ...
                <Modal open={open} onClose={handleClose}>
                    ...
                    >
                        <h2 className="text-green-600 text-[20px] font-semibold">
