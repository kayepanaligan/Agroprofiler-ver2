...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`/admin/farmprofile/${farmer.id}`);
        ...
        <Authenticated user={auth.user}>
            ...
            <div className="grid grid-cols-4 h-full gap-0 p-[0.5rem]">
                <div className="relative left-0 h-full border-r px-4 py-2 border-slate-200 ">
                    ...
                    <div className="flex ml-2 dark:text-green-600 mt-10 font-semibold text-[24px] flex-wrap ">
                ...
                <div className="relative col-span-3 right-0 h-full px-6 py-4">
                    <span className="text-lg text-[30px] dark:text-green-600 text-slate-700 font-semibold">
                        Data History
                    </span>
                        ...
                        <Tabs>
                            <Tab label="Allocation">
                                <div className="flex justify-between px-4">
                                    <h1 className="text-green-600 text-[18px] font-semibold px-4 py-5">
                                        Allocation History
                                    </h1>
                                    <Button
                ...
                <Modal show={modalOpen} onClose={() => setModalOpen(false)}>
                    {modalType === "allocation" && (
                        <div className="p-10 h-50">
                            <h2 className="font-semibold mb-2 text-[20px] dark:text-green-600 text-green-800">
                                {formData.id
                                    ? "Edit Allocation"
                                    : "Add Allocation"}
                            </h2>
                    ...
                    {modalType === "damage" && (
                        <div className="p-10">
                            ...
                            >
                                ...
                                {formData.imagePreview && (
                                    <div className="mt-4">
                                        <label className="block dark:text-white mb-2 font-semibold text-[15px]">
                                            Image Preview:
                                        </label>
                                        <img
                                            src={formData.imagePreview}
                        ...
                        <div className="p-10">
                            ...
                            >
                                <Select
                                    ...
                                    placeholder="Select Commodity"
                                    className="rounded-2xl mb-4 dark:text-white"
                                    styles={customStyles(isDarkMode)}
                                />
                                <Select
                                    options={barangays}
