        ...
        if (name === "rsbsa_ref_no" && value.length >= 5) {
            try {
                const response = await axios.get(
                    `/admin/api/check-farmer?rsbsa_ref_no=${value}`
                );
        ...
        if (name === "firstname" || name === "lastname") {
            try {
                ...
                if (firstname.trim() !== "" && lastname.trim() !== "") {
                    const response = await axios.get(
                        `/admin/api/check-farmer?firstname=${firstname}&lastname=${lastname}`
                    );
        ...
        >
                ...
                <div className="p-8 h-[600px] overflow-auto">
                    ...
                    <div className="mt-4">
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                <option
                                    className="dark:bg-[#122231] dark:text-white"
                                    value=""
                                    disabled
                                >
                                    Gender
                            ...
                            <select
                                ...
                                onChange={handleSelectChange}
                                className="w-full rounded-lg border-gray-300 mb-2 text-slate-500 dark:bg-[#122231] dark:text-white"
                            >
                                <option
                                    className="dark:bg-[#122231] dark:text-white"
                                    value=""
                            ...
                            <div>
                                <input
                                    ...
                                    className="w-full border-gray-300 rounded-lg shadow-sm mb-2 text-slate-500 dark:bg-[#122231]"
                                    required
                                />
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="mt-1 w-full border-gray-300 rounded-lg shadow-sm dark:bg-[#122231]"
                                />
                            </div>
            ...
            {selectedFarmer && (
                <Modal show={isEditModalOpen} onClose={closeEditModal}>
                    <div className="p-5">
                        <div className="p-2 ">
                            <h2 className="text-[20px] mb-2 text-green-600 font-semibold">
                                Edit Farmer
                            </h2>
                        </div>
                        ...
                        <div>
                            <form onSubmit={handleUpdate}>
                                <div className="px-6 py-4 h-[500px] overflow-auto mb-11">
                                    <div className="px-4">
                                        <InputLabel
                                        ...
                                        <TextInput
                                            ...
                                            placeholder="RSBSA Reference Number (Optional)"
                                    ...
                                    <div className="px-4">
                                        ...
                                        <select
                                            name="sex"
                                            className="rounded-lg border-gray-300 w-full mb-4"
                                    ...
                                    <div className="px-4">
                                        ...
                                        <select
                                            ...
                                            className="w-full rounded-lg border-gray-300 mb-4 dark:[#122231]"
                                        >
                                            <option
                                                className="dark:[#122231]"
                                                value=""
                                                disabled
                                            >
                                                Barangay
                                    ...
                                    <div className="px-4">
                                        <InputLabel
                                            value="Is the farmer a 4ps Beneficiary?"
                                            htmlFor="4ps"
                                        />
                                        <select
                                            name="4ps"
                                ...
                                <div className="fixed bottom-0 bg-white dark:bg-transparent w-full py-4  px-6">
