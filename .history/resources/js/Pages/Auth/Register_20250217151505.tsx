        ...
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                <div className="p-4 h-[500px] overflow-auto">
                    <br />
                    <h1 className="text-center text-bolder text-[25px] font-semibold text-slate-800">
                        Create an account
                    </h1>
                    <br />
                    <div className="mt-4 ">
                        <div className="flex gap-5">
                            <div>
                                ...
                                />
                                <div
                                    className="w-24 h-24 rounded-md overflow-hidden border-2 border-yellow-300 hover:border-green-500 cursor-pointer"
