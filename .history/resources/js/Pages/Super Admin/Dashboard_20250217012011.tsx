        ...
        >
            ...
            <div className="flex mb-5 gap-4 w-20">
                <select
                    ...
                    className="rounded-[12px] border border-slate-200 p-2 text-[15px] w-[470px] cursor-pointer outline-none after:outline-none"
                >
                    {years.map((year) => (
                    ...
                    {commodityCategoryDistribution?.map((category) => {
                        const chartData = category.commodities.map(
                            (commodity: {
                                ...
                                value: commodity.commodity_total.toLocaleString(),
                            })
                        );
                        return (
                            <Card
