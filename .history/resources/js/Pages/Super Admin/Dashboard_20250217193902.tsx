        ...
        >
            ...
            <div className="flex mb-5 gap-4 w-20">
                <select
                    ...
                    className="rounded-[12px] text-white dark:focus:ring-green-400 dark:border-green-700 dark:border-[2px] p-2 px-4 dark:bg-[#0D1A25] text-[15px] w-[470px] cursor-pointer outline-none after:outline-none"
                >
                    {years.map((year) => (
