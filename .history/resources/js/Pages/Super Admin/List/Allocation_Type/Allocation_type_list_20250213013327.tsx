...
export default function AllocationTypeList({ auth }: PageProps) {
    ...
    const columns: GridColDef[] = [
        ...
        { field: "name", headerName: "Name", flex: 2, width: 200 },
        { field: "desc", headerName: "Description", flex: 2, width: 200 },
        { field: "amount", headerName: "Amount", flex: 2 },
        { field: "identifier_title", headerName: "Identifier", flex: 2 },
        { field: "funding_name", headerName: "Source", flex: 2 },
        {
            field: "commodities",
