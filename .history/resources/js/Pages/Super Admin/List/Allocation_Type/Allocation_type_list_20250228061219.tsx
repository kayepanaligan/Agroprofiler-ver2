...
interface AllocationTypeRow {
    ...
    allocation_type_commodities: { commodity_name: string }[];
    allocation_type_barangays: { barangay_name: string }[];
    allocation_type_elligibilities: { elligibility_type: string }[];
    allocation_type_crop_damage_causes: { crop_damage_cause_name: string }[];
}
...
export default function AllocationTypeList({ auth }: PageProps) {
    ...
    const rows: AllocationTypeRow[] = (allocationTypes || []).map(
        (type, index) => ({
            ...
            identifier_title: type.identifier_title || "No Identifier",
            allocation_type_id: type.allocation_type_id || "", // Ensure this field exists
