...
interface AllocationTypeRow {
    ...
    allocation_type_commodities: { commodity_name: string }[]; // Adjusted
    allocation_type_barangays: { barangay_name: string }[]; // Adjusted
    allocation_type_elligibilities: { elligibility_type: string }[]; // Adjusted
