...
export default function AllocationList({
    ...
    const handleSubmit: FormEventHandler = async (e) => {
        ...
        if (
            ...
            !newAllocation.identifier_id || // Ensure identifier is selected
            !newAllocation.funding_id // Ensure funding is selected
        ) {
        ...
        // Explicitly ensure identifier_id and funding_id are included
                ...
                <div className="p-10">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <TextInput
                            ...
                            placeholder={newAllocation.funding_name}
                            className="mt-3 w-full rounded-lg border-gray-300"
                            disabled
                        />
