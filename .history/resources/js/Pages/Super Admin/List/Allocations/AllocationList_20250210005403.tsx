...
import { Download, EyeIcon, Pencil, Plus, PlusIcon, Trash } from "lucide-react";
...
export default function AllocationList({
    ...
    const handleEdit = (allocationID: number) => {
        ...
        if (allocation) {
            ...
            console.log("Selected farmer: ", allocation); // Log the selected farmer data
        } else {
    ...
    return (
        ...
        >
            ...
            <Box
                sx={{ height: "550px", padding: "10px", borderRadius: "10px" }}
            >
                <DataGrid
                    rows={allocations}
                    columns={columns}
