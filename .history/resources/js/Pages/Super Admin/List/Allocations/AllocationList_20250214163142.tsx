...
export default function AllocationList({
    ...
    const handleFarmerSelect = (farmer: Farmer | null) => {
                ...
                <div className="p-10">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Select
                            ...
                            value={
                                newAllocation.farmer
                                    ? {
                                          value: newAllocation.farmer.id,
                                          label: `${newAllocation.farmer.firstname} ${newAllocation.farmer.lastname}`,
                                      }
                                    : null
                            }
