...
export default function CropActivityFolder({ auth }: FarmerProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        formData.append("image", image); // Ensure `image` is the binary file
        formData.append("crop_activity_id", cropActivityId);
        ...
        try {
            ...
            const newImage = response.data.image; // Adjust this to match your backend's response
