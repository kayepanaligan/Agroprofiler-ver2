...
export default function Images({
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        // Ensure image is selected when not editing
        ...
        const url = isEditing
            ? `/cropactivity/images/update/${selectedImageId}`
            : "/cropactivity/images/store";

        try {
            // Make the request to store or update the image using Axios
            ...
            if (response.data.success && response.data.image) {
                // If editing, update the image in the list
                if (isEditing) {
