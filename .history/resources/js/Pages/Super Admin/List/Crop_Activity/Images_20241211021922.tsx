...
export default function Images({
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        formData.append("title", title); // Assuming title and desc are from state
        formData.append("desc", desc);
        if (imageFile) {
            formData.append("image", imageFile); // Add the new image file if any
        }
        ...
        try {
            ...
            if (response.ok) {
                console.log("Updated image:", data.image); // Log updated image data
