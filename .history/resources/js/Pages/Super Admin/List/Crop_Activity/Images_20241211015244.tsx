...
export default function Images({
    ...
    const handleEdit = (id: number) => {
        ...
        if (selectedImage) {
            // Populate modal fields with the selected image's data
            setTitle(selectedImage.title);
            setDesc(selectedImage.desc);
            setImagePreview(selectedImage.file_path); // Assuming the file path is used for preview
            setImageFile(null); // Reset the file input to prevent accidental overwrites
