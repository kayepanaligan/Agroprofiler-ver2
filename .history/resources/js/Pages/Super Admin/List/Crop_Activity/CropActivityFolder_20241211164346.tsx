    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (editingFolderId) {
            ...
            router.patch(`/cropactivity/update/${editingFolderId}`, payload, {
                onSuccess: (response: { folder: CropActivityFolder }) => {
                    ...
                    setFolders((prevFolders) => {
                        ...
                        console.log("Updated folders:", updatedFolders); // Log updated folders
            ...
            router.post("/cropactivity/store", payload, {
                onSuccess: (response: { folder: CropActivityFolder }) => {
                    console.log("New folder response:", response); // Log the new folder response
                    const newFolder = response.folder;
                    setFolders((prevFolders) => {
                        const updatedFolders = [...prevFolders, newFolder];
                        console.log(
                            "Updated folders after adding:",
                            updatedFolders
                        );
                        return updatedFolders;
                    });
