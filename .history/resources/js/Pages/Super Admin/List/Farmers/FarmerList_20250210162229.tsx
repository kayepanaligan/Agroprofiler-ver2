                    ...
                    <div className="mt-4">
                        <form onSubmit={handleSubmit}>
                            ...
                            {existingFarmers.length > 0 && (
                                <div className="border p-2 rounded-lg shadow-md bg-white absolute z-50 w-full">
                                    {existingFarmers.map((farmer) => (
                                        <div
                                            key={farmer.id}
                                            className="p-2 cursor-pointer hover:bg-gray-200"
                                            onClick={() => {
                                                setSelectedExistingFarmer(
                                                    farmer
                                                );
                                                setFarmerDetailModal(true);
                                            }}
                                        >
                            ...
                            <Modal
                                show={farmerDetailModal}
                                onClose={() => setFarmerDetailModal(false)}
                            >
                                <div className="p-6">
                                    {selectedFarmer && (
                                        <>
