                    ...
                    >
                        ...
                        <Autocomplete
                            ...
                            onHighlightChange={(event, option) => {
                                ...
                                setAnchorEl(event?.currentTarget || null); // Get the hovered element's position
                            }}
                            value={
                                farmers.find(
                                    (farmer) => farmer.id === formData.farmer_id
                            ...
                            renderOption={(props, option) => (
                                <Box
                                    ...
                                    onMouseEnter={(e) => {
                                        ...
                                        setAnchorEl(e.currentTarget); // Capture the hovered element
                                    }}
                                    onMouseLeave={() => setHoveredFarmer(null)} // Hide on mouse out
                                    sx={{ padding: "8px" }}
                                >
                                    {option.firstname} {option.lastname}
                                </Box>
                        ...
                        {hoveredFarmer && anchorEl && (
                            ...
                            >
                                ...
                                <p>Barangay: {hoveredFarmer.brgy_id}</p>
                            </div>
                        )}
