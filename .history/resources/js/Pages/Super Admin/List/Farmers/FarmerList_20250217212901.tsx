                ...
                <DataGrid
                    ...
                    sx={{
                        "& .MuiDataGrid-columnHeaders": {
                            backgroundColor:
                                theme === "dark" ? "#333" : "#f5f5f5", // Dark header for dark mode
                            color: theme === "dark" ? "#00ff00" : "#000000", // Green text for dark mode, black for light mode
                        },
                        "& .MuiDataGrid-cell": {
                            color: theme === "dark" ? "white" : "#000000", // Green text for dark mode, black for light mode
                        },
                        "& .MuiCheckbox-root": {
                            color:
                                theme === "dark"
                                    ? "#00ff00 !important"
                                    : "#000000 !important", // Checkbox color change
                        },
                        padding: "5px",
                        border: "none",
                    }}
                ...
                <Modal show={isEditModalOpen} onClose={closeEditModal}>
                    <div className="p-5">
                        <div className="p-2 border-b-[1px] border-slate-300 mb-4">
                            <h2 className="text-[20px] mb-2 text-green-700 font-semibold">
                                Edit Farmer
                            </h2>
                        </div>
                        ...
                        <div>
                            <form onSubmit={handleUpdate}>
                                ...
                                <div className="fixed bottom-0 bg-white w-full py-4  px-6">
