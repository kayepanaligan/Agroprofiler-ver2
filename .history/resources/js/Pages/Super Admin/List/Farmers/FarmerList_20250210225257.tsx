...
import { EyeIcon, Import, Pencil, PlusIcon, Trash } from "lucide-react";
...
export default function FarmerList({
...

        {
            ...
            renderCell: (params) => (
                <div className="p-2 px-1 flex gap-2">
                    <button
                        className="border rounded-[12px] p-2"
    ...
    const handleSubmit: FormEventHandler = async (e) => {
        ...
        try {
            // Optimistic UI: Add farmer locally before waiting for API
            ...
            // Ensure fetched data includes the newly added farmer
            fetchFarmerData();
            ...
            // Remove farmer from UI if request fails (rollback optimistic update)
    ...
    return (
        ...
        >
            ...
            <Box sx={{ height: "590px", padding: "2px", border: "none" }}>
                <DataGrid
                    rows={farmersData}
                    columns={columns}
                    initialState={{
