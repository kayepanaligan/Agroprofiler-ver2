        ...
        >
            ...
            <div style={{ height: 500, width: "100%" }}>
                ...
                onHighlightChange={(event, option) => {
                    setHoveredFarmer(option || null);
                }}
                value={farmers.find((farmer) => farmer.id === formData.farmer_id) || null}
                className="dark:border-green-600"
                renderInput={(params) => (
                    <TextField
                        {...params}
                ...
                renderOption={(props, option) => (
                    ...
                    >
                        <Avatar src={option.profile_picture} alt={option.firstname} />
                        {option.firstname} {option.lastname}
                    </Box>
                )}
            />
            ...
            {hoveredFarmer && (
                ...
                >
                    <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                        <Avatar
                            src={hoveredFarmer.profile_picture}
                            alt={hoveredFarmer.firstname}
                            sx={{ width: 60, height: 60 }}
                        />
                        <Box>
                            <strong>{hoveredFarmer.firstname} {hoveredFarmer.lastname}</strong>
                            <p>{hoveredFarmer.address}</p>
                            <p>Birthday: {hoveredFarmer.birthday}</p>
