        ...
        try {
            ...
            setFarms(
                response.data.map((farm: any) => ({
                    label: farm.name,
                    value: farm.id,
                    commodity_id: farm.commodity_id, // Store for commodity dependency
                    brgy_id: farm.brgy_id, // Store for barangay dependency
                    ha: farm.ha, // Store for severity calculation
                }))
            );
        } catch (error) {
