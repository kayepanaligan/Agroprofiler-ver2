        ...
        <Authenticated user={auth.user}>
            ...
            <div className="grid grid-cols-4 h-full gap-0 p-[0.5rem]">
                <div className="relative left-0 h-full border-r px-4 py-2 border-slate-200 ">
                    ...
                    <div className="flex content-center justify-center mt-10 font-semibold text-[24px] flex-wrap ">
                ...
                <div className="relative col-span-3 right-0 h-full px-6 py-4">
                    <span className="text-lg dark:text-green-600 text-slate-700 font-semibold">
                        Data History
                    </span>
                ...
                <Modal show={modalOpen} onClose={() => setModalOpen(false)}>
                    {modalType === "allocation" && (
                        <div className="p-10 h-50">
                            <h2 className="font-semibold text-lg mb-2 text-[20px] text-green-800">
                                {formData.id
                                    ? "Edit Allocation"
                                    : "Add Allocation"}
                            </h2>
                            ...
                            >
                                <div className="p-4">
                                    ...
                                    <label className="block mt-4 font-semibold px-4 text-[15px]">
                                    ...
                                    <select
                                        ...
                                        className="w-full border rounded-md border-slate-400 p-2"
                                    >
                        ...
                        <div className="p-10">
                            ...
                            >
                                ...
                                <div>
                                    <label
                                        htmlFor="proof"
                                        className="block mb-2 font-semibold text-[15px]"
                                    >
                                        Upload Image Proof:
                                    </label>
                                    <TextInput
