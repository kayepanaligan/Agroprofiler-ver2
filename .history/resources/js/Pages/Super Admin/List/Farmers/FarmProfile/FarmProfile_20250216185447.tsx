...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    const handleSelectFarm = (selectedOption: any) => {
        setFormData({
            ...
            commodity_id: selectedOption.commodity_id, // Auto-set commodity
            brgy_id: selectedOption.brgy_id, // Auto-set barangay
            farm_ha: selectedOption.ha, // Store for severity calculation
        });
    };
