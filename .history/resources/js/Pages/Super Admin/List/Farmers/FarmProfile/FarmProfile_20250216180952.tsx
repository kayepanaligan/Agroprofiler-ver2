        ...
        try {
            ...
            setAllocationType(
                allocationTypeData.data.map((allocationType: any) => ({
                    ...
                    funding: allocationType.funding, // Store funding info
                    identifier: allocationType.identifier, // Store identifier info
                    amount: allocationType.amount, // Store total amount
                    barangays: allocationType.barangays, // Store related barangays
                    commodities: allocationType.commodities, // Store related commodities
                }))
            );
                            ...
                            <Tab label="Allocation">
                                ...
                                <Timeline
                                    ...
                                    fieldConfig={[
                                        ...
                                        {
                                            key: "received",
                                            label: "Was the allocation Received",
                                        },
                                        {
                                            key: "dateReceived",
                                            label: "Date Received",
