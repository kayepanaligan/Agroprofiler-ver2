    ...
    const handleSelectChange = (
        ...
        if (field === "farm_id" && selectedOption) {
            const selectedFarm = farms.find(
                (farm: Option) => farm.value === selectedOption.value
            );
            ...
            setFormData((prevData) => ({
                ...prevData,
                farm_id: Number(selectedOption.value), // Ensure it's a number
                farm_size: farmSize,
            ...
            setFormData((prevData) => ({
                ...prevData,
                [field]: selectedOption ? Number(selectedOption.value) : 0, // Ensure consistency
            }));
        }
    };
