    ...
    return (
        ...
        >
            ...
            <div className="grid grid-flow-row grid-rows-1 gap-3">
                <div className="2xl:grid grid-flow-row grid-rows-1 gap-3">
                    <div className="flex gap-2 ">
                        <Card title="Farmers" className="lg:w-50">
                            <div>
                                <h1 className="font-semibold lg:text-2xl border-none">
                                    Total: {totalFarmers}
                                </h1>
                                <hr />
                ...
                <div className="flex gap-2 flex-wrap justify-center content-center ">
                    {commodityCategoryDistribution?.map((category) => {
                        ...
                        return (
                            <Card
                                ...
                                className="mb-1 w-[550px] capitalize"
                            >
                                <h1 className="font-semibold text-2xl">
