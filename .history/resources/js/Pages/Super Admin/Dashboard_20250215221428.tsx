...
export default function Dashboard({
    ...
    const fetchData = async (year: string, month: string) => {
        try {
            const response = await axios.get("/api/indexResponse", {
                params: {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <h2 className="text-2xl block font-medium text-green-800 leading-tight">
                    Dashboard
                </h2>
            }
        >
            ...
            {data ? (
                <div>
                    <p>Total Allocations: {data.totalAllocations}</p>
                    <p>Registered Farmers: {data.registeredFarmers}</p>
                    <p>Unregistered Farmers: {data.unregisteredFarmers}</p>
            ...
            <div className="flex mb-5 gap-4">
                ...
                <div className="w-400 bg-green-500"></div>
            </div>
