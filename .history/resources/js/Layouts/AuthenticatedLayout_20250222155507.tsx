        ...
        <ThemeProvider>
            <div className=" ">
                <div className="grid grid-flow-col gap-4 mt-4 transition-all duration-300">
                    ...
                    <main
                        className={`pb-5 rounded-[1rem] max-w-[1190px] max-h-[1500px] row-span-3 bg-white dark:bg-[#0d1a25] shadow-sm transition-all-ease duration-7000 ${
                            expanded
                                ? "ml-[290px] w-[calc(100%-310px)]"
                                : "ml-[220px] w-[calc(100%-330px)]"
                        }`}
                    >
                        {header && (
                            <header>
