        ...
        <ThemeProvider>
            <div className=" ">
                <div className="grid grid-flow-col gap-4 mt-4 transition-all duration-300">
                    ...
                    <main
                        className={`pb-5 rounded-[1rem] row-span-3 bg-white dark:bg-[#0d1a25] shadow-sm transition-all-ease duration-7000 ${
                            expanded
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <div className="mt-6 ml-4 h-[590px] overflow-auto max-w-10xl mx-auto sm:px-6 lg:px-5 overflow-auto">
                                {children}
                            </div>
                        </div>
                    </main>
