...
export default function Authenticated({ user, header, breadcrumbs, children, }) {
    ...
    return (_jsx(ThemeProvider, { children: _jsx("div", { className: " ", children: _jsxs("div", { className: "grid grid-flow-col gap-4 mt-4 transition-all duration-300", children: [_jsx(Sidebar, { user: user, expanded: expanded, setExpanded: setExpanded }), _jsxs("main", { className: `flex flex-col pb-5 rounded-[1rem] row-span-3 bg-white dark:bg-[#0d1a25] overflow-x-auto scrollbar-none shadow-sm transition-all-ease duration-7000 ${expanded
