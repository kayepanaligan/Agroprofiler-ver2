...
export default function Authenticated({
    ...
    return (
        <ThemeProvider>
            <div className=" ">
                <div className="grid grid-flow-col grid-cols-4 mt-4">
                    <Sidebar user={user} />

                    <main className="col-span-3 absolute pb-5 w-[80%] rounded-[1rem] right-5 row-span-3 bg-white dark:bg-[#0d1a25] shadow-sm">
                        {header && (
                            <header>
