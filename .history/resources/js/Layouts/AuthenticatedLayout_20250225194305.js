...
export default function Authenticated({ user, header, breadcrumbs, children }) {
    ...
    return _jsx(ThemeProvider, {
        children: _jsx("div", {
            ...
            children: _jsxs("div", {
                className:
                    "grid grid-flow-col gap-4 mt-4 transition-all duration-300",
                children: [
                    _jsx(Sidebar, {
                        user: user,
                        expanded: expanded,
                        ...
                        children: [
                            header &&
                                _jsx("header", {
                                    children: _jsx("div", {
                                        className:
                                            "relative top-[2rem] max-w-10xl mx-auto py-3 px-3 sm:px-6 lg:px-8",
                                        children: header,
                                    }),
                                }),
                            _jsx("div", {
                            ...
                            _jsx("div", {
                                className:
                                    "mt-6 ml-4 h-[580px] py-4 w-[100%] mx-auto sm:px-6 lg:px-8 ",
                                children: children,
                            }),
                        ],
                    }),
