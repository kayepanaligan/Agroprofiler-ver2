...
class DashboardController extends Controller
{
    ...
    $selectedMonth = $request->query('month', null); // Default to null (no filter by month)

    $barangays = Barangay::all();
    $allocationType = AllocationType::all();
    $commodityCategories = CommodityCategory::with('commodities')->get();

    // Get distinct years from allocations
    $years = Allocation::selectRaw('YEAR(created_at) as year')->distinct()->pluck('year');
