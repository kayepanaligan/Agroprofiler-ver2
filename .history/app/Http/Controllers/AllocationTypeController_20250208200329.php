    ...
    public function index()
    {
        ...
        $output = $allocationTypes->map(function ($allocationType) {
            return [
                ...
                'funding_id' => optional($allocationType->funding)->id, // Add funding
                'funding_name' => optional($allocationType->funding)->name, // Add funding name
                'identifier_id' => optional($allocationType->identifier)->id, // Add identifier
