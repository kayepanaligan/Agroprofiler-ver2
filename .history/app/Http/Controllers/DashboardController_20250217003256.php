...
class DashboardController extends Controller
{
   ...
   public function index(Request $request) {
    ...
    $allocations = Allocation::whereYear('created_at', $selectedYear)->get();

    // Filter registered/unregistered farmers by year (if applicable)
    ...
    $unregisteredFarmers = Farmer::where('status', 'unregistered')
        ->whereYear('created_at', $selectedYear)
        ->count();
    $totalFarmers = Farmer::whereYear('created_at', $selectedYear)->count();

    $heatmapData = [];

    foreach ($barangays as $barangay) {
        $barangayFarms = Farm::with('farmer')
