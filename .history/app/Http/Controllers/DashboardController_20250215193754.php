...
public function indexResponse(Request $request) {
    $selectedYear = $request->query('year', date('Y')); // Default to current year
    $selectedMonth = $request->query('month', null); // Default to null (no month filter)
    ...
    // ✅ Filter Farmers by Year and Month
    ...
    // ✅ Filter Farms by Year and Month
    ...
    foreach ($barangays as $barangay) {
        // ✅ Filter Barangay Farms by Year and Month
