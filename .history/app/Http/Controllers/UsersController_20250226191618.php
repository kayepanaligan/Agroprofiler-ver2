...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pfp')) {
            ...
            $file->move(public_path('pfp'), $filename); // Save directly to public/pfp
            $pfpUrl = asset("pfp/{$filename}"); // Use /pfp URL directly
        }
        ...
        public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'pfp' => 'nullable|string', /* The code snippet you provided is a part of the validation
            rules for updating a user's information in the
            UsersController class of a Laravel application. */// Accept base64 string
            'firstname' => 'required|string|max:255',
            'lastname' => 'required|string|max:255',
            'role' => 'required|string|max:255',
            'status' => 'required|string|max:255',
