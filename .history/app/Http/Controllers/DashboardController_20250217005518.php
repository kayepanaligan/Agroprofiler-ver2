...
public function index(Request $request) {
    ...
    // Count total allocations directly from DB
    $totalAllocations = Allocation::when($selectedYear !== 'all', function ($query) use ($selectedYear) {
    ...
    $totalFarmers = Farmer::when($selectedYear !== 'all', fn($query) => $query->whereYear('created_at', $selectedYear))
        ->count();
    ...
    foreach ($barangays as $barangay) {
        ...
        foreach ($allocationType as $type) {
            $count = Allocation::where('allocation_type_id', $type->id)
    ...
    return Inertia::render('Super Admin/Dashboard', [
        'totalAllocations' => $totalAllocations, // Corrected count
        'allocationType' => $allocationType,
        'registeredFarmers' => $registeredFarmers,
        'unregisteredFarmers' => $unregisteredFarmers,
        'totalFarmers' => $totalFarmers,
