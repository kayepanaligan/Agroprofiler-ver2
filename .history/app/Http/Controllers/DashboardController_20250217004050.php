...
class DashboardController extends Controller
{
   ...
   public function index(Request $request) {
    ...
    // Get distinct years from the allocations table
    ...
    array_unshift($years, 'All'); // Add "All" as the first option

    // Fetch allocations, considering "All" selection
    ...
    // Fetch farmers based on selected year
    $farmersQuery = Farmer::query();
    if ($selectedYear !== 'all') {
        $farmersQuery->whereYear('created_at', $selectedYear);
    }
