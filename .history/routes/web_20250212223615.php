...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    Route::get('/crop-damages/import', [CropDamageImportController::class, 'showImportForm'])->name('crop-damages.import-form');
    Route::post('/crop-damages/import', [CropDamageImportController::class, 'import'])->name('crop-damages.import');
    Route::post('/api/import-crop-damages', function (Request $request) {
        $request->validate([
