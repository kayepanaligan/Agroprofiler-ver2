...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    Route::get('/api/allocation-type/{id}/dependencies', function ($id) {
        ...
        return response()->json([
            ...
            'identifier_id' => $allocationType->identifiers ? $allocationType->identifier->id : null,
            'identifier_name' => $allocationType->identifiers ? $allocationType->identifier->title : null,
            'funding_id' => $allocationType->fundings ? $allocationType->funding->id : null,
            'funding_name' => $allocationType->fundings ? $allocationType->funding->name : null,
        ]);
    });
