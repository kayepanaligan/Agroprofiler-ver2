...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    //funding
    Route::get('/admin/fundings', [FundingController::class, 'index'])->name('funding.index');
    ...
    //identifer
    Route::get('/admin/identifier', [IdentifierController::class, 'index'])->name('identifier.index');
