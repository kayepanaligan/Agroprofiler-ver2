...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    Route::post('/admin/allocation/store', [AllocationTypeController::class, 'store'])->name('allocation.store');
     Route::delete('/admin/allocation/destroy/{id}', [AdminAllocationTypeController::class, 'destroy'])->name('allocation.destroy');
