...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    Route::post('/admin/commodities/store', [CommodityController::class, 'store'])->name('commodities.store');
    ...
    Route::delete('/admin/allocations/destroy/{id}', [AllocationController::class, 'destroy'])->name('allocation.destroy');
    Route::post('/admin/allocations/destroy/{id}', [AllocationController::class, 'destroy']);
    Route::post('/admin/allocations/store', [AllocationController::class, 'store'])->name('allocation.store');
    Route::put('/admin/allocations/update/{id}', [AllocationController::class, 'update'])->name('allocation.update');

   //cropactivity
    Route::get('/admin/cropactivity', [CropActivityController::class, 'index'])->name('crop.activity.index');
    Route::put('/admin/cropactivity/update/{id}', [CropActivityController::class, 'update'])->name('crop.activity.update');
    Route::delete('/admin/cropactivity/destroy/{id}', [CropActivityController::class, 'destroy'])->name('crop.activity.destroy');
    Route::post('/admin/cropactivity/destroy/{id}', [CropActivityController::class, 'destroy']);

    Route::post('/admin/cropactivity/store', [CropActivityController::class, 'store'])->name('crop.activity.store');


    //images
    Route::get('/admin/cropactivity/images/{id}', [ImagesController::class, 'images'])->name('crop.activity.images');
    Route::post('/admin/cropactivity/images/store', [ImagesController::class, 'store'])->name('crop.images.activity.store');
    Route::put('/admin/cropactivity/images/update/{id}', [ImagesController::class, 'update'])->name('crop.images.activity.update');
    ...
    Route::get('/admin/crop-damages-causes', [CropDamageCauseController::class, 'index'])->name('crop.damage.causes');
