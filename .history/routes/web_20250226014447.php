...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    Route::delete('/admin/cropdamages/destroy/{id}', [CropDamagesController::class, 'destroy'])->name('crop.damages.destroy');
    Route::post('/admin/store/cropdamages', [CropDamagesController::class, 'store'])->name('crop.damages.store');
    Route::post('/admin/cropdamages/update/{id}', [CropDamagesController::class, 'update'])->name('crop.damages.update');
    Route::get('/admin/cropdamages/data', [CropDamagesController::class, 'showCropDamages'])->name('crop.damages.data');
