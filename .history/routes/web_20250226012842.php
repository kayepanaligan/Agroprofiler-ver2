...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    //dashboard
    Route::get('/admin/barangays/data', [AllocationController::class, 'showBarangays'])->name('barangay.data');
    Route::get('/admin/allocations/data', [AllocationController::class, 'showAllocations'])->name('allocations.data');
    Route::get('/admin/farmers/data', [FarmerController::class, 'showFarmers'])->name('farmers.data');
    ...
    Route::get('/admin/cropdamages/get', [CropDamagesController::class, 'index'])->name('crop.damages.index');
   ...
   //cropactivity
    ...
    Route::get('/admin/crop-damages-ui', [CropDamageCauseController::class, 'show'])->name('crop.damage.show');
