...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    Route::get('/admin/search/farmers/data', [RetrieverController::class, 'getFarmers']);
    Route::get('/admin/search/data/farms', [RetrieverController::class, 'getFarms']);
    Route::post('/admin/api/users/delete', function (Request $request) {
        $ids = $request->input('ids');
        User::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::get('/admin/list/farmers', function () {
        return Farmer::select('id', 'firstname', 'lastname', 'brgy_id', 'age', 'sex')->get();
    });
    Route::get('/admin/list/barangays', function () {
        return Barangay::select('id', 'name')->get();
    });
     Route::get('/admin/list/commodities', function () {
        return Commodity::select('id', 'name')->get();
    });
    Route::post('/admin/farms/import', [FarmController::class, 'import']);
    //latest routes

    Route::get('/admin/dashboard', [DashboardController::class, 'showAdmin'])->name('admin.dashboard');
    Route::get('/admin/report/resource-allocation-breakdown', [RecommendationController::class, 'generateAllocationBreakdownReport']);
    Route::get('/admin/generate-report', [RecommendationController::class, 'generateReport']);

    //new routes
    Route::get('/admin/data/farms', [RetrieverController::class, 'getFarmsByFarmer']);
    Route::get('/admin/farms', [FarmController::class, 'adminIndex'])->name('admin.farm.index');
    // Route::get('/admin/data/farmss', [FarmController::class, 'showData']);
    Route::post('/admin/api/import', [ImportController::class, 'import']);
    Route::post('/admin/import-allocations', function (Request $request) {
        $request->validate([
    ...
    Route::get('/admin/api/check-farmer', [FarmerController::class, 'checkFarmer']);
    Route::get('/admin/api/farmers', [FarmerController::class, 'getFarmers']);
    Route::get('/admin/api/allocation-type/{id}/dependencies', function ($id) {
        $allocationType = AllocationType::find($id);
        ...
        return response()->json([
            ...
            'identifier_id' => $allocationType->identifier ? $allocationType->identifier->id : null,
            'identifier_name' => $allocationType->identifier ? $allocationType->identifier->title : null,
            'funding_id' => $allocationType->funding ? $allocationType->funding->id : null,
            'funding_name' => $allocationType->funding ? $allocationType->funding->name : null,
        ]);
    });
    Route::get('/admin/indexresponse', [DashboardController::class, 'indexResponse']);
    Route::get('/admin/api/allocations/remaining-balance/{allocationTypeId}', [AllocationController::class, 'getRemainingBalance']);
    Route::post('/admin/api/allocations/delete', function (Request $request) {
        $ids = $request->input('ids');
        Allocation::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/api/cropdamages/delete', function (Request $request) {
        $ids = $request->input('ids');
        CropDamage::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/api/farms/delete', function (Request $request) {
        $ids = $request->input('ids');
        Farm::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/api/categorycommodities/delete', function (Request $request) {
        $ids = $request->input('ids');
        CommodityCategory::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/api/commodities/delete', function (Request $request) {
        $ids = $request->input('ids');
        Commodity::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/api/fundings/delete', function (Request $request) {
        $ids = $request->input('ids');
        Funding::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/api/allocationtypes/delete', function (Request $request) {
        $ids = $request->input('ids');
        AllocationType::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/api/identifiers/delete', function (Request $request) {
        $ids = $request->input('ids');
        Identifier::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
     Route::post('/admin/api/cropdamagecauses/delete', function (Request $request) {
        $ids = $request->input('ids');
        CropDamageCause::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/admin/import-crop-damages', function (Request $request) {
        $request->validate([
    ...
    Route::post('/admin/upload-proof', function (Request $request) {
        $request->validate([
    ...
    Route::post('/admin/api/farmers/delete', function (Request $request) {
        $ids = $request->input('ids');
        Farmer::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });

    Route::get('/admin/farms/{farmer_id}', function ($farmer_id) {
        return response()->json(Farm::where('farmer_id', $farmer_id)->get());
    });

    Route::get('/admin/farms/details/{farmId}', function ($farmId) {
        return App\Models\Farm::findOrFail($farmId);
    });


    //funding
    Route::get('/admin/fundings', [FundingController::class, 'adminIndex'])->name('admin.funding.index');
    Route::get('/admin/api/fundings', [FundingController::class, 'showFunding']);
    Route::post('/admin/store/fundings', [FundingController::class, 'store']);
    Route::put('/admin/update/fundings/{id}', [FundingController::class, 'update']);
    Route::delete('/admin/destroy/fundings/{id}', [FundingController::class, 'destroy']);

    //identifer
    Route::get('/admin/identifier', [IdentifierController::class, 'adminIndex'])->name('admin.identifier.index');
    Route::get('/admin/api/identifier', [IdentifierController::class, 'showFunding']);
    Route::post('/admin/store/identifier', [IdentifierController::class, 'store']);
    Route::put('/admin/update/identifier/{id}', [IdentifierController::class, 'update']);
    Route::delete('/admin/destroy/identifier/{id}', [IdentifierController::class, 'destroy']);

    Route::get('/admin/commoditycategorycounts', [DashboardController::class, 'commodityCategoryCounts']);
    ...
    Route::put('/admin/allocationtypes/update/{id}', [AllocationTypeController::class, 'update']);
    Route::get('/admin/allocation-type-counts', [DashboardController::class, 'allocationTypes']);
    Route::get('/admin/commodity-counts', [DashboardController::class, 'commodityCounts']);
    Route::get('/admin/farmer-counts', [DashboardController::class, 'farmerCounts']);

    //dashboard
    Route::get('/admin/barangays/data', [AllocationController::class, 'showBarangays'])->name('admin.barangay.data');
    Route::get('/admin/allocations/data', [AllocationController::class, 'showAllocations'])->name('admin.allocations.data');
    Route::get('/admin/farmers/data', [FarmerController::class, 'showFarmers'])->name('admin.farmers.data');
    Route::get('/admin/users/data', [UsersController::class, 'showUsers'])->name('admin.users.data');
    Route::get('/admin/heatmap-data', [DashboardController::class, 'getHeatmapData']);

    Route::delete('/admin/cropdamages/destroy/{id}', [CropDamagesController::class, 'destroy'])->name('admin.crop.damages.destroy');
    Route::post('/admin/store/cropdamages', [CropDamagesController::class, 'store'])->name('admin.crop.damages.store');
    Route::post('/admin/cropdamages/update/{id}', [CropDamagesController::class, 'update'])->name('admin.crop.damages.update');
    Route::get('/admin/cropdamages/data', [CropDamagesController::class, 'showCropDamages'])->name('admin.crop.damages.data');
    Route::get('/admin/cropdamages/get', [CropDamagesController::class, 'admin'])->name('admin.crop.damages.index');

    //allocation type
    Route::get('/admin/allocation/allocationtype', [AllocationTypeController::class, 'showAdmin'])->name('admin.allocation.type.index');
    Route::post('/admin/allocation/store', [AllocationTypeController::class, 'store'])->name('admin.allocation.store');
     Route::delete('/admin/allocation/destroy/{id}', [AdminAllocationTypeController::class, 'destroy'])->name('admin.allocation.destroy');
    ...
    Route::get('/admin/commodity-categories-list', [CommodityCategoryController::class, 'index'])->name('admin.commodity.index');
    ...
    Route::post('/admin/commodities/store', [CommodityController::class, 'store'])->name('admin.commodities.store');
    Route::get('/admin/commodities/list', [CommodityController::class, 'index'])->name('admin.commodity.list.index');
    ...
    Route::get('/admin/map/farm', [MapController::class, 'index'])->name('map.index');

    //farmprofile
    Route::get('/admin/farmprofile/{id}', [FarmProfileController::class, 'admin'])->name('admin.farm.profile.index');
    Route::get('/admin/data/farmprofile/{id}', [FarmProfileController::class, 'show'])->name('admin.farm.profile.index');

    //Farmers
    Route::get('/admin/farmers', [FarmerController::class, 'admin'])->name('admin.farmers.index');
    Route::post('/admin/farmers/store', [FarmerController::class, 'store'])->name('admin.farmers.store');
    ...
    Route::delete('/admin/farmers/destroy/{id}', [FarmerController::class, 'destroy'])->name('admin.farmers.destroy');
    ...
    Route::post('/admin/farms/destroy/{id}', [FarmController::class, 'destroy']);
    //allocations
    Route::get('/admin/allocations', [AllocationController::class, 'showAdmin'])->name('admin.allocations.index');
    Route::delete('/admin/allocations/destroy/{id}', [AllocationController::class, 'destroy'])->name('admin.allocation.destroy');
    Route::post('/admin/allocations/destroy/{id}', [AllocationController::class, 'destroy']);
    Route::post('/admin/allocations/store', [AllocationController::class, 'store'])->name('admin.allocation.store');
    Route::put('/admin/allocations/update/{id}', [AllocationController::class, 'update'])->name('admin.allocation.update');

   //cropactivity
    Route::get('/admin/cropactivity', [CropActivityController::class, 'index'])->name('admin.crop.activity.index');
    Route::put('/admin/cropactivity/update/{id}', [CropActivityController::class, 'update'])->name('admin.crop.activity.update');
    Route::delete('/admin/cropactivity/destroy/{id}', [CropActivityController::class, 'destroy'])->name('admin.crop.activity.destroy');
    Route::post('/admin/cropactivity/destroy/{id}', [CropActivityController::class, 'destroy']);

    Route::post('/admin/cropactivity/store', [CropActivityController::class, 'store'])->name('admin.crop.activity.store');


    //images
    Route::get('/admin/cropactivity/images/{id}', [ImagesController::class, 'images'])->name('admin.crop.activity.images');
    ...
    Route::get('/admin/recommendations', [RecommendationController::class, 'admin'])->name('admin.recommendations.index');
    Route::get('/admin/export-pdf', [ExportController::class, 'exportPDF']);
    Route::get('/admin/geospatial', [GeospatialController::class, 'index'])->name('admin.geospatial.index');

    Route::post('/admin/recommend-allocations', [RecommendationController::class, 'recommendAllocations']);
    Route::get('/admin/api/recommend-allocations', [RecommendationController::class, 'recommendAllocations']);
    Route::get('/admin/allocation-types', [RecommendationController::class, 'listAllocationTypes']);
    ...
    Route::get('/admin/crop-damages-causes', [CropDamageCauseController::class, 'index'])->name('admin.crop.damage.causes');
    ...
    Route::get('/admin/api/farmers', [DashboardController::class, 'getFarmersDistribution']);
    Route::get('/admin/api/allocations', [DashboardController::class, 'getAllocationsDistribution']);
    Route::get('/admin/api/stacked-data', [DashboardController::class, 'getStackedData']);
    Route::get('/admin/allocation-counts', [DashboardController::class, 'getCounts']);
...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    Route::get('/search/farmers/data', [RetrieverController::class, 'getFarmers']);
    Route::get('/search/data/farms', [RetrieverController::class, 'getFarms']);
    Route::post('/api/users/delete', function (Request $request) {
        $ids = $request->input('ids');
        User::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::get('/list/farmers', function () {
        return Farmer::select('id', 'firstname', 'lastname', 'brgy_id', 'age', 'sex')->get();
    });
    Route::get('/list/barangays', function () {
        return Barangay::select('id', 'name')->get();
    });
     Route::get('/list/commodities', function () {
        return Commodity::select('id', 'name')->get();
    });
    Route::post('/farms/import', [FarmController::class, 'import']);
    //latest routes
    ...
    //new routes
    Route::get('/data/farms', [RetrieverController::class, 'getFarmsByFarmer']);
    ...
    Route::get('/api/farmers', [FarmerController::class, 'getFarmers']);
    ...
    Route::get('/indexresponse', [DashboardController::class, 'indexResponse']);
    Route::get('/api/allocations/remaining-balance/{allocationTypeId}', [AllocationController::class, 'getRemainingBalance']);
    ...
    Route::post('/api/commodities/delete', function (Request $request) {
        $ids = $request->input('ids');
        Commodity::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/api/fundings/delete', function (Request $request) {
        $ids = $request->input('ids');
        Funding::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/api/allocationtypes/delete', function (Request $request) {
        $ids = $request->input('ids');
        AllocationType::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    Route::post('/api/identifiers/delete', function (Request $request) {
        $ids = $request->input('ids');
        Identifier::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
     Route::post('/api/cropdamagecauses/delete', function (Request $request) {
        $ids = $request->input('ids');
        CropDamageCause::whereIn('id', $ids)->delete();
        return response()->json(['message' => 'Records deleted successfully'], 200);
    });
    ...
    Route::post('/farms/destroy/{id}', [FarmController::class, 'destroy']);
    //allocations
    ...
    Route::post('/allocations/destroy/{id}', [AllocationController::class, 'destroy']);
   ...
   //cropactivity
    ...
    Route::put('/cropactivity/update/{id}', [CropActivityController::class, 'update'])->name('crop.activity.update');
    Route::delete('/cropactivity/destroy/{id}', [CropActivityController::class, 'destroy'])->name('crop.activity.destroy');
    Route::post('/cropactivity/destroy/{id}', [CropActivityController::class, 'destroy']);
