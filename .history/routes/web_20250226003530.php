...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    Route::get('/admin/farmers/admin/data', [FarmerController::class, 'showFarmers'])->name('admin.farmers.data');
    Route::get('/admin/admin/users/data', [UsersController::class, 'showUsers'])->name('admin.users.data');
