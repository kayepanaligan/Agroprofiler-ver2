...
Route::post('/fundings', [FundingController::class, 'store']);
Route::put('/fundings/{id}', [FundingController::class, 'update']);
Route::delete('/fundings/{id}', [FundingController::class, 'destroy']);

    //funding
    // Route::get('/funding/index', [FundingController::class, 'index'])->name('funding.index');
