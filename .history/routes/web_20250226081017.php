...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    Route::get('/admin/commodities/list', [CommodityController::class, 'admin'])->name('admin.commodity.list.index');
    ...
    Route::get('/admin/data/farmprofile/{id}', [FarmProfileController::class, 'show'])->name('admin.profile.index');
