...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    //identifer
    Route::get('/fundings', [IdentifierController::class, 'index'])->name('identifer.index');
    Route::get('/api/fundings', [IdentifierController::class, 'showFunding']);
    Route::post('/store/fundings', [IdentifierController::class, 'store']);
    Route::put('/update/fundings/{id}', [IdentifierController::class, 'update']);
    Route::delete('/destroy/fundings/{id}', [IdentifierController::class, 'destroy']);
    ...
    Route::post('/allocation/store', [AdminAllocationTypeController::class, 'store'])->name('allocation.store');
