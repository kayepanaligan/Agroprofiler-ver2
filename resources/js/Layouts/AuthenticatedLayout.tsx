        ...
        <ThemeProvider>
            <div className="mb-10">
                <div className="grid grid-flow-col gap-4 mt-4 transition-all duration-300">
                    ...
                    <main
                        className={`flex flex-col pb-5 rounded-[1rem] row-span-3 bg-white dark:bg-[#0d1a25] h-[96%] overflow-x-auto scrollbar-none shadow-sm transition-all-ease duration-7000 fixed ${
                            expanded
                    ...
                    >
                        ...
                        <div className="mt-6 mb-6 ml-4 h-[10%] py-4 w-[100%] mx-auto sm:px-6 lg:px-8 ">
                            <div>
                            {children}
                            </div>
                        </div>
