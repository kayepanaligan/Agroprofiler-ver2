...
export default function Sidebar({ user, expanded, setExpanded }: Props) {
    ...
    return (
        <div
            className={`fixed z-20 p-5 overflow-x-auto bg-white h-[96%] dark:bg-[#0D1A25] rounded-[1rem] ml-3 shadow ${
