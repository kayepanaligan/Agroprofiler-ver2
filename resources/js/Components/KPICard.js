...
export function CropDamageKPICard({ percentage, intensityPercentages, mostAffectedCommodity, mostImpactedGroup, topCropDamageCause, mostAffectedBarangay, }) {
    ...
    return (_jsx(KPICard, { title: "Farmers Affected by Crop Damage", mainValue: percentage, mainLabel: "%", tooltip: "Percentage of farmers who have experienced crop damage", icon: _jsx(AlertTriangle, { size: 24 }), color: "red", subheading: _jsxs("div", { className: "space-y-2 mt-3", children: [_jsx("div", { className: "flex items-center gap-2 sm:gap-4 flex-wrap", children: intensityData.map((intensity) => (_jsxs("div", { className: "flex items-center gap-1 sm:gap-2 relative group", onMouseEnter: () => setHoveredIntensity(intensity.level), onMouseLeave: () => setHoveredIntensity(null), children: [_jsx("div", { className: `w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full ${intensity.color}` }), _jsxs("span", { className: "text-[10px] sm:text-xs font-semibold dark:text-white", children: [intensity.percentage, "%"] }), hoveredIntensity === intensity.level && (_jsxs("div", { className: "absolute z-10 bottom-full mb-2 left-1/2 transform -translate-x-1/2 p-2 bg-gray-800 text-white text-[10px] font-normal rounded-lg shadow-lg whitespace-nowrap", children: [intensity.tooltip, _jsx("div", { className: "absolute top-full left-1/2 transform -translate-x-1/2 -mt-1", children: _jsx("div", { className: "border-4 border-transparent border-t-gray-800" }) })] }))] }, intensity.level))) }), _jsxs("div", { className: "flex flex-wrap items-center gap-1 sm:gap-2", children: [_jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Most Affected Commodity: " }), _jsx("span", { className: "text-xs font-semibold dark:text-white", children: mostAffectedCommodity }), _jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "\u2022" }), _jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Most Impacted Group: " }), _jsx("span", { className: "text-xs font-semibold dark:text-white", children: mostImpactedGroup }), topCropDamageCause && topCropDamageCause !== 'N/A' && (_jsx(_Fragment, { children: _jsxs("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: ["(affected by ", topCropDamageCause, ")"] }) })), _jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "\u2022" }), _jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Most Affected Barangay: " }), _jsx("span", { className: "text-xs font-semibold dark:text-white", children: mostAffectedBarangay })] })] }) }));
}
export function AllocationCoverageKPICard({ percentage, totalPlanned, totalDelivered, topAllocationType, topAllocationSource, topAllocatedCommodity, avgAllocationPerFarm, topAllocatedBarangays, }) {
    return (_jsx(KPICard, { title: "Allocation Distribution Coverage", mainValue: percentage, mainLabel: "%", tooltip: `This represents the percentage of planned allocations (₱${totalPlanned.toLocaleString()}) that have been successfully delivered (₱${totalDelivered.toLocaleString()}) to farmers.`, icon: _jsx(Package, { size: 24 }), color: "blue", subheading: _jsxs("div", { className: "space-y-2 mt-3", children: [_jsxs("div", { children: [_jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Top allocation type and its source: " }), _jsxs("span", { className: "text-xs font-semibold dark:text-white", children: [topAllocationType, topAllocationSource && topAllocationSource !== 'N/A' && (_jsxs("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: [" from (", topAllocationSource, ")"] }))] })] }), _jsxs("div", { children: [_jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Top allocated commodity: " }), _jsx("span", { className: "text-xs font-semibold dark:text-white", children: topAllocatedCommodity })] }), _jsxs("div", { children: [_jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Avg allocation per farm: " }), _jsxs("span", { className: "text-xs font-semibold dark:text-white", children: ["\u20B1", avgAllocationPerFarm.toLocaleString()] })] }), _jsxs("div", { children: [_jsx("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Top barangay(s) who received the most of this allocation type: " }), _jsx("span", { className: "text-xs font-semibold dark:text-white", children: topAllocatedBarangays.length > 0 ? topAllocatedBarangays.join(", ") : "N/A" })] })] }) }));
}
