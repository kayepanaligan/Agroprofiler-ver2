                ...
                <div className="flex-1">
                    {Object.keys(fields).map((key) =>
                        ...
                        !fields[key].match(/\.(jpeg|jpg|gif|png)$/) ? (
                            <p
                                key={key}
                                className="text-[14px] text-gray-600 text-ellipsis font-semibold dark:text-white"
                            >
        ...
        <div className="timeline-container">
            <div className="mb-4 ml-12">
                <TextInput
                    ...
                    className="w-[430px] px-4 py-2 border border-gray-300 dark:bg-transparent dark:text-white dark:border-green-400 rounded-md shadow-sm"
                />
            </div>
