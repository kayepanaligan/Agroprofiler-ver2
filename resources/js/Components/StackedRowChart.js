...
const StackedRowChart = ({ data, colors }) => {
    ...
    useEffect(() => {
        ...
        g.append("g")
            ...
            tooltip
                .style("opacity", 1)
                .html(`<strong>${d.data.category}</strong><br>Value: ${x1 - x0}`)
    ...
    return (_jsxs("div", { children: [_jsx("svg", { ref: chartRef, width: 800, height: 400 }), _jsx("div", { id: "tooltip", style: {
                    position: "absolute",
                    opacity: 0,
