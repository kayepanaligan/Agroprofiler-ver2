...
export default function FarmProfile({ auth, farmer }) {
    ...
    const handleSaveAllocation = async () => {
        ...
        try {
            ...
            const response = await axios.post("/allocations/store", dataToSend, {
    ...
    const handleUpdateAllocation = async () => {
        ...
        try {
            ...
            const response = await axios.post(`/allocations/update/${formData.id}`, dataToSend, { headers: { "Content-Type": "application/json" } });
    ...
    const handleSaveCropActivity = async () => {
        ...
        try {
            ...
            const response = await axios.post("/cropactivity/store", dataToSend, {
                headers: { "Content-Type": "multipart/form-data" },
            });
    ...
    const handleUpdateCropActivity = async () => {
        ...
        try {
            ...
            const response = await axios.post(`/cropactivity/update/${formData.id}`, // Adjusted route
    ...
    const handleSaveCropDamage = async () => {
        ...
        try {
            ...
            const response = await axios.post("/store/cropdamages", dataToSend, {
                headers: { "Content-Type": "multipart/form-data" },
            });
    ...
    const handleUpdateCropDamage = async () => {
        ...
        try {
            ...
            const response = await axios.post(`/cropdamages/update/${formData.id}`, dataToSend, { headers: { "Content-Type": "multipart/form-data" } });
    ...
    const handleUpdateFarm = async () => {
        ...
        try {
            ...
            const response = await axios.put(`/farms/update/${formData.id}`, dataToSend, { headers: { "Content-Type": "application/json" } });
