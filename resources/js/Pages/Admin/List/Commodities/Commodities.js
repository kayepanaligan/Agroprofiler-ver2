...
const Commodities = ({ auth }) => {
    ...
    const handleSave = async () => {
        try {
            if (isEdit) {
                console.log(`PUT request to: /admin/commodities-categories/update/${formData.id}`);
                const response = await axios.put(`/admin/commodities-categories/update/${formData.id}`, formData);
                fetchData();
                ...
                const response = await axios.post("/admin/commodity-categories/store", formData);
                fetchData();
                toast.success(response.data.message, {
                    draggable: true,
                    closeOnClick: true,
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`/admin/commodity-categories/destroy/${id}`);
    ...
    const handleMultipleDelete = async () => {
        ...
        try {
            setLoading(true);
            await axios.post("/admin/api/categorycommodities/delete", {
                ids: selectedIds,
            });
