...
const AllocationVsDamageTitle = () => {
    const [showTooltip, setShowTooltip] = useState(false);
    return (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { children: "Allocation vs. Damage Alignment" }), _jsxs("div", { className: "relative", onMouseEnter: () => setShowTooltip(true), onMouseLeave: () => setShowTooltip(false), children: [_jsx(HelpCircle, { className: "w-4 h-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 cursor-help" }), showTooltip && (_jsxs("div", { className: "absolute left-0 top-full mt-2 w-80 p-3 bg-gray-800 dark:bg-gray-900 text-white text-xs rounded-lg shadow-lg z-50", children: [_jsx("div", { className: "absolute bottom-full left-4 w-0 h-0 border-l-4 border-r-4 border-b-4 border-transparent border-b-gray-800 dark:border-b-gray-900" }), _jsx("p", { className: "mb-2", children: "This chart compares allocation amounts (blue bars) with crop damage percentages (red bars) per barangay." }), _jsxs("p", { className: "mb-2", children: [_jsx("strong", { children: "What to look for:" }), " Ideally, the heights of red bars (Damage %) and blue bars (Allocation) should follow a similar pattern. Discrepancies indicate areas where allocation policy might need adjustment."] }), _jsx("p", { className: "text-xs", children: "Hover over each bar to see detailed information and alignment status." })] }))] })] }));
};
