...
const Recommendation = ({ auth, allocationDetails, }) => {
    ...
    useEffect(() => {
        const fetchAllocationTypes = async () => {
            try {
                const response = await axios.get("/admin/allocation-types");
